...
namespace Evento.Infrastructure.Repositories
{
    public class EventRepository : IEventRepository
    {
        private static readonly ISet<Event> _events = new HashSet<Event>()
        {
             ...
             new Event (Guid.NewGuid(), "Event 2", "Event 1 description", DateTime.UtcNow.AddHours(5), DateTime.UtcNow.AddHours(10)),
             new Event (Guid.NewGuid(), "Event 3", "Event 1 description", DateTime.UtcNow.AddHours(10), DateTime.UtcNow.AddHours(12)),
             new Event (Guid.NewGuid(), "Event 4", "Event 1 description", DateTime.UtcNow.AddHours(8), DateTime.UtcNow.AddHours(20))
        };
